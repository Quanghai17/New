                ...
                <div class="col-md-4 gn-animation" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                    <div class="widget widget-brand">
                        <div class="logo logo-footer">
                             {{-- <a href="#"><img src="{{ asset('assets/images/logo.svg') }}" alt="Good News"></a> --}}
                        </div>
                    ...
                    <div class="widget widget-social">
                        ...
                        <div class="social-list">
                            <a href="#"><img src="{{asset('assets/images/facebook.svg')}}" alt="image"></a>
                            <a href="#"><img src="{{asset('assets/images/twitter.svg')}}" alt="image"></a>
                            <a href="#"><img src="{{asset('assets/images/youtube.svg')}}" alt="image"></a>
                            <a href="#"><img src="{{asset('assets/images/dribbble.svg')}}" alt="image"></a>
                        </div>
                        <a class="email" href="#">{{setting('site.email')}}</a>
                    </div><!-- /.widget-social -->
                </div><!-- /.col-md-4 -->
